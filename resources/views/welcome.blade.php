...
<!--/notification -->
<body class="bg-gray-700 dark:bg-gray-950 text-sans overflow-hidden">
<main class="flex flex-col h-screen relative mx-auto lg:max-w-7xl">
    <!-- Header -->
            <nav class="bg-gray-800 rounded-xl">
                <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    <div class="relative flex flex-row h-16 items-center justify-between">
                        <div class="flex basis-1/3 items-center justify-center sm:items-stretch sm:justify-start">
                                ...
                                <div class="relative">
                                    <div>
                                        <button type="button" class="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                            ...
                                            <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name=admin&background=random&size=160" alt="">
                                    ...
                                    <div class="absolute left-0 mt-2 w-40 rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none opacity-0" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                                        ...
                                        <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-200" role="menuitem" tabindex="-1" id="user-menu-item-2">Выйти</a>
                                    </div>
                                </div>
                                <!-- /Auth -->
                            </div>
                        ...
                        <div class="basis-1/3 flex justify-center items-center">
                            <img class="h-8 w-auto" src="https://static.vecteezy.com/system/resources/previews/022/636/379/non_2x/starbucks-logo-starbucks-icon-transparent-free-png.png" alt="Your Company">
                        </div>
                        <!-- Menu -->
                        <div class="flex">
    ...
    <!--Row-->
        <div class="w-full h-full text-white mt-5 grid grid-cols-3 gap-x-5">
            ...
            <!-- /Menu sections -->
            <!-- Menu list -->
            <div class="flex flex-col p-5 gap-x-3 gap-y-1 bg-gray-800 rounded-xl overflow-scroll">
                <div class="text-center bg-gray-700 rounded-t-xl">
                    <p>Горячий кофе</p>
                </div>
                <div class="grid grid-cols-2 gap-x-5 gap-y-2 place-items-stretch text-lg h-96 w-fit break-words" id="products-container">
                    @foreach($coffee as $cof)
                        <div class="flex-col bg-gray-900 hover:bg-gray-700 h-32 w-44 flex justify-center items-center relative">
        ...
        <!-- Order -->
            <div class="flex flex-col w-full p-5 gap-x-3 bg-gray-800 rounded-xl">
                <button type="button" class="text-white bg-gray-950 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 rounded-lg text-lg px-5 py-2.5 me-2 w-full dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                    Оплата
                </button>
            </div>
        <!-- /Order -->
            ...
            <div class="flex flex-col p-5 gap-x-3 bg-gray-800 rounded-xl">
                <div class="grid grid-cols-2 justify-between">
                    <div class="col w-full text-center">
                        <button type="button" class="text-white bg-gray-950 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 rounded-lg text-lg px-5 py-2.5 me-2 w-40 dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                            Клиент
                        </button>
                    </div>
                    <div class="col w-full text-center">
        ...
        <!-- Menu list -->
            <div class="flex flex-col p-5 gap-x-3 bg-gray-800 rounded-xl h-fit">
                <button type="button" class="text-white bg-gray-950 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 rounded-lg text-lg px-5 py-2.5 me-2 w-full dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                    Сохранить заказ
                </button>
            </div>
        <!-- /Menu list -->
